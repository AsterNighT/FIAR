...
int displayTutorial() {
    ...
    printf("\
    -------------------------------------------------------------------\n\
    Name a cordinate to determine where to place your pieces.\n\
    For now, replay and game save&load are supported.\n\
    Both replay the save info are represented by strings encoded by ASCII, just grab your code and save it to a text file or somewhere.\n\
    Press enter to return to menu.\n\
    -------------------------------------------------------------------\n\
    ");
    pause();
...
int displayMainMenu() {
    ...
    \033[40;33m2: Local multiplayer\033[0m\n\
